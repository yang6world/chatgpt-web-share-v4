...
async def generate_ppt(file_path, topic, slide_length):
    folder = Path() / "data" / "ppt" / "caches" 
    ...
    root.save(str(folder) + f"/{topic}.pptx")
    ...
    return os.getcwd() + "/" + str(folder) + f"/{topic}.pptx"
