...
export interface components {
  schemas: {
    ...
    ConfigModel: {
       ...
       *   "open_poeapi_url": "None"
       *   "open_otherapi_url": "None"
       *   "connect_timeout": 10,
       *   "read_timeout": 20
       * }
       */
     ...
     * @enum {string}
     */
    OpenaiApiChatModels: "gpt_3_5" | "gpt_sage" | "claude_instant" | "claude_plus" | "gpt_4";
    /**
    ...
    OpenaiApiSetting: {
      ...
      open_poeapi_url?: string;
      open_otherapi_url?: string;
      /** Proxy */
      proxy?: string;
      /**
       * Connect Timeout 
